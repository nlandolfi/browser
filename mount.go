...
//
// If the Mounter has a non-nil Requests channel, it will attach
// event listeners, and send requests on the Requests channel.
type Mounter struct {
	...
	//	// Requests is the channel on which to send Requests generated by the
	//	// user interface.
